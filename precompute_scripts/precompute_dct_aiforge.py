"""
Precomputes DCT data for AIForge-Doc's 812 test images. 
"""
...
T = 20
image_dir = '/mnt/c/Users/SARA/Desktop/AIFORGE-V1/TestingSet/images'
cache_dir = 'dct_cache_aiforge_test'
...
print(f"Finished. {done} AIForge-Doc test images cached in {cache_dir}/")
