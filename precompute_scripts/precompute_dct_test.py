...
T = 20
cache_dir = 'dct_cache_test'
os.makedirs(cache_dir, exist_ok=True)

with open('data_prep/DocTamperV1-TestingSet_indices_no_copymove.pk', 'rb') as f:
    keep_indices = pickle.load(f)

env = lmdb.open('DocTamperV1-TestingSet', readonly=True, lock=False, readahead=False, meminit=False)
...
print(f"Finished. {done} test images cached in {cache_dir}/")
