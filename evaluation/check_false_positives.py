"""
chekcs how often does the model incorrectly flag genuinely authentic
AIForge-Doc images as forged
"""
...
print(f"\nFalse positive rate: {flagged_count}/{len(filenames)} ({100*flagged_count/len(filenames):.1f}%) genuinely authentic images incorrectly flagged as forged.")
